...
{
    public partial class pagecode_report_absence_wfh : System.Web.UI.UserControl
    {
        ...
        {
            var url = ConfigurationManager.AppSettings.Get("wsURL1") + "/rest/reportwfh/" + nrp1 + "/" + month1 + "/" + year1;
            ...
            lblInfo.Text = "Report Absensi - Claim Internet WFH anda akan dikirimkan ke alamat E-Mail anda";
        }
    }
}