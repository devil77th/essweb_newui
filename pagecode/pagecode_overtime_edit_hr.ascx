<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pagecode_overtime_edit_hr.ascx.cs" Inherits="WebApplication1.pagecode.pagecode_overtime_edit_hr" %>
...
<table style="width:100%">
    ...
    <tr>
     ...
     <tr>
        ...
        <td style="width:50%;text-align:center">
            <asp:Button CssClass="btn btn-lg btn-primary btn-block" ID="cmdReject" runat="server" Text="Reject" 
                Width="90%" OnClick="cmdReject_Click" />          
        </td>
        </tr>
        </table>
        </td>
