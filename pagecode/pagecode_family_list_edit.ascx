<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pagecode_family_list_edit.ascx.cs" Inherits="WebApplication1.pagecode.pagecode_family_list_edit" %>
<asp:ScriptManager ID="ScriptManager1" runat="server">
</asp:ScriptManager>
<script type="text/javascript">
       function delconfirmation1() {
 ...
 <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:Button  ID="cmdDelete1" runat="server" Text="Delete Data" Width="150px" OnClick="cmdDelete1_Click" 
                OnClientClick="return delconfirmation1()"/>
        </td>
    </tr>
</table>
<asp:HiddenField ID="hidID1" runat="server" />
<asp:HiddenField ID="hidID2" runat="server" />
<asp:HiddenField ID="hidIDFamily1" runat="server" />