<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pagecode_report_absence_wfh.ascx.cs" Inherits="WebApplication1.pagecode.pagecode_report_absence_wfh" %>
     ...
     <tr>
        <td>
            <asp:Button CssClass="btn btn-lg btn-primary btn-block" ID="cmdReqReportAbsence" 
                runat="server" Text="Request Report Absensi WFH" OnClick="cmdReqReportAbsence_Click" />
