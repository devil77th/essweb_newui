<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pagecode_request_cico_wfh_list.ascx.cs" Inherits="WebApplication1.pagecode.pagecode_request_cico_wfh_list" %>
<style type="text/css">   
...
<table style="width:100%">
    ...
    <tr>
        <td>
            <asp:GridView ID="gvcicowfh1" runat="server" AllowPaging="true" AutoGenerateColumns="false" 
                    PageSize="10" Width="100%" OnPageIndexChanging="gvcicowfh1_PageIndexChanging" OnRowCommand="gvcicowfh1_RowCommand"
    ...
    <tr>
        ...
        <asp:Button CssClass="btn btn-lg btn-primary btn-block" ID="cmdAdd" runat="server" OnClick="cmdAdd_Click"
            Width="100%" Text="Request CI/CO WFH" />    
        </td>
    </tr>
</table>