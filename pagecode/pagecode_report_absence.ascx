<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pagecode_report_absence.ascx.cs" Inherits="WebApplication1.pagecode.pagecode_report_absence" %>
     ...
     <tr>
        <td>
            <asp:Button CssClass="btn btn-lg btn-primary btn-block" ID="cmdReqReportAbsence" 
                runat="server" Text="Request Report Absence" OnClick="cmdReqReportAbsence_Click" />
